...
CREATE TABLE `capacity` (
  ...
  `direct_directID` int NOT NULL,
  PRIMARY KEY (`capacityID`),
  KEY `fk_capacity_direct1_idx` (`direct_directID`),
  CONSTRAINT `fk_capacity_direct1` FOREIGN KEY (`direct_directID`) REFERENCES `direct` (`directID`)
